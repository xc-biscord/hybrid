...
export class ServerApiClient {
  ...
  getMyRole(serverId) { return this.get(`/get_my_server_role.php?server_id=${encodeURIComponent(serverId)}`); }
  getServerName(serverId) { return this.get(`/get_server_name.php?id=${encodeURIComponent(serverId)}`); }
  ...
  getChannels(serverId) { return this.get(`/get_channels.php?server_id=${encodeURIComponent(serverId)}`); }
  createChannel(serverId, name) { return this.postJson("/create_channel.php", { server_id: serverId, name }); }
  getMembers(serverId) { return this.get(`/get_users_in_server.php?server_id=${encodeURIComponent(serverId)}`); }
  ...
  getUserProfile(userId) { return this.get(`/get_user_profile.php?user_id=${encodeURIComponent(userId)}`); }
  ...
  getMessages(channelId) { return this.get(`/get_messages.php?channel_id=${encodeURIComponent(channelId)}`); }
