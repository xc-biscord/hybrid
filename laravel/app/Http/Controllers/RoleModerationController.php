...
final class RoleModerationController extends BaseApiController
{
    ...
    public function getMyServerRole(int $userId, ?int $serverId): JsonResponse
    {
        try {
    ...
    public function listUsersInServer(int $actorUserId, int $serverId): JsonResponse
    {
        try {
    ...
    public function setMemberRole(int $actorUserId, array $data): JsonResponse
    {
    ...
    public function kickMember(int $actorUserId, array $data): JsonResponse
    {
        $serverId = (int) ($data['server_id'] ?? 0);
        $targetUserId = (int) ($data['target_user_id'] ?? 0);
