...
final class DmController extends BaseApiController
{
    ...
    public function start(int $currentUserId, array $input): JsonResponse
    {
        try {
    ...
    public function messages(int $userId, int $conversationId): JsonResponse
    {
        try {
    ...
    public function send(int $senderId, array $data): JsonResponse
    {
        try {
    ...
    public function notifications(int $userId): JsonResponse
    {
        try {
